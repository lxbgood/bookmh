...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = Color.parseColor("#FF0000");
	private int underlineColor1 = Color.parseColor("#c5c5c5");;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		lastpad= (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, lastpad, dm);
...
//			v.setBackgroundResource(tabBackgroundResId);
			...
			if(i==tabCount-1)
			{
				v.setPadding(tabPadding, 0, tabPadding+lastpad, 0);
			}
...
//			if (childWidth <= myWidth) {
		defaultTabLayoutParams = new LinearLayout.LayoutParams(getWidth()/num, LayoutParams.MATCH_PARENT);
		for (int i = 0; i < tabCount; i++) {
...
//		 draw underline
		...
		//底部回线
		rectPaint.setColor(underlineColor1);
		canvas.drawRect(0, height - underlineHeight*num, tabsContainer.getWidth(), height - underlineHeight, rectPaint);
		// draw indicator line
		...
		if (currentPositionOffset > 0f && currentPosition < tabCount - 1) {
			...
			if(currentPosition==tabCount-2 )
			{
				nextTabRight=nextTabRight-lastpad;
			}
...
//		lineLeft=lineLeft+tabPadding;
//		lineRight=lineRight-tabPadding;
		//红线
